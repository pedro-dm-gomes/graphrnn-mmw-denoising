...
def get_model(point_cloud, is_training, model_params):
  ...
  l0_feats = tf_util.conv1d(point_cloud, 12, 1, padding='VALID', bn=BN_FLAG, is_training=is_training, scope='pre_l0', bn_decay=bn_decay)
  ...
  """ -----  Layer 1    -----  """
  l1_xyz = l0_xyz
  l1_feats = tf.concat( (l0_xyz, timestep_tensor,l0_feats) ,axis = 2)
  # GNN layer 1
  ...
  """ -----  Layer 2    -----  """
  l2_xyz = l1_xyz
  l2_feats = tf.concat( (l0_xyz, timestep_tensor,l1_feats) ,axis = 2)
  ...
  """ -----  Layer 3    -----  """
  l3_xyz = l2_xyz
  l3_feats = tf.concat( (l0_xyz,timestep_tensor, l2_feats) ,axis = 2)
