...
def get_model(point_cloud, is_training, model_params):
  ...
  point_cloud = tf.reshape(point_cloud, (batch_size,seq_length*num_points, 1, 3) )
  print("point_cloud.shape", point_cloud.shape)
  ...
  net_last = tf_util.conv2d(net, 64, [1,1],
                      padding='VALID', stride=[1,1],
                      bn=BN_FLAG, is_training=is_training,
...
def get_acurracy_loss(predicted_labels, ground_truth_labels, context_frames = 0 ): 
  """
