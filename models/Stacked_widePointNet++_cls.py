...
def get_model(point_cloud, is_training, model_params):
  ...
  #l1
  l1_xyz, l1_points, l1_indices = pointnet_sa_module(l0_xyz, l0_points, npoint=int(num_points/sampled_points_down1), knn= True, radius=0.2, nsample=4,  mlp=[64,64], mlp2=None, group_all=False, is_training=is_training, bn_decay=bn_decay, scope='layer1')
  l1_points = tf_util.dropout(l1_points, keep_prob=0.75, is_training=is_training, scope='dp_l1')
  #l2
  l2_xyz, l2_points, l2_indices = pointnet_sa_module(l1_xyz, l1_points, npoint=int(num_points/sampled_points_down2), knn= True, radius=0.4, nsample=4, mlp=[128,128], mlp2=None, group_all=False, is_training=is_training, bn_decay=bn_decay, scope='layer2')
  l2_points = tf_util.dropout(l2_points, keep_prob=0.75, is_training=is_training, scope='dp_l2')
  #l3
  l3_xyz, l3_points, l3_indices = pointnet_sa_module(l2_xyz, l2_points, npoint=int(num_points/sampled_points_down3), knn= True, radius=None, nsample=4, mlp=[128,128], mlp2=None, group_all=False, is_training=is_training, bn_decay=bn_decay, scope='layer3')  
  l3_points = tf_util.dropout(l3_points, keep_prob=0.75, is_training=is_training, scope='dp_l3')
  #l4
  l4_xyz, l4_points, l4_indices = pointnet_sa_module(l3_xyz, l3_points, npoint=int(num_points/(sampled_points_down3*2) ), knn= True, radius=None, nsample=4, mlp=[256,256], mlp2=None, group_all=False, is_training=is_training, bn_decay=bn_decay, scope='layer4')  
  l4_points = tf_util.dropout(l4_points, keep_prob=0.75, is_training=is_training, scope='dp_l4')
  ...
  print("l4_points", l4_points)
  print("--")
  
    

  # Feature Propagation layers
  l3_points = pointnet_fp_module(l3_xyz, l4_xyz, l3_points, l4_points, [256,128], is_training, bn_decay, scope='fa_layer0')
  l2_points = pointnet_fp_module(l2_xyz, l3_xyz, l2_points, l3_points, [128,128], is_training, bn_decay, scope='fa_layer1')
  ...
  # FC layers
  net = tf_util.conv1d(l0_points, 64, 1, padding='VALID', bn=BN_FLAG, is_training=is_training, scope='fc1', bn_decay=bn_decay)
  net = tf_util.dropout(net, keep_prob=0.75, is_training=is_training, scope='dp1')
  net = tf_util.conv1d(net, 64, 1, padding='VALID', bn=BN_FLAG, is_training=is_training, scope='fc2', bn_decay=bn_decay)
  net = tf_util.dropout(net, keep_prob=0.75, is_training=is_training, scope='dp2')
  net_last = net
