...
def get_model(point_cloud, is_training, model_params):
  ...
  l1_xyz, l1_points, l1_indices = pointnet_sa_module(l0_xyz, l0_points, npoint=sampled_points_down1, knn= True, radius=0.2, nsample=num_samples,  mlp=[64,64], mlp2=None, group_all=False, is_training=is_training, bn_decay=bn_decay, scope='layer1')
  l2_xyz, l2_points, l2_indices = pointnet_sa_module(l1_xyz, l1_points, npoint=sampled_points_down2, knn= True, radius=0.4, nsample=num_samples, mlp=[128,128], mlp2=None, group_all=False, is_training=is_training, bn_decay=bn_decay, scope='layer2')
  l3_xyz, l3_points, l3_indices = pointnet_sa_module(l2_xyz, l2_points, npoint=sampled_points_down3, knn= True, radius=None, nsample=num_samples, mlp=[256,256], mlp2=None, group_all=False, is_training=is_training, bn_decay=bn_decay, scope='layer3')  
  ...
  l0_points = pointnet_fp_module(l0_xyz, l1_xyz, None, l1_points, [128], is_training, bn_decay, scope='fa_layer3')
