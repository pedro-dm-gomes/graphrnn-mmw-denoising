...
def eval_one_epoch(sess,ops,test_writer, epoch):
    ...
    for batch_idx in tqdm ( range(num_batches) ):
      ...
      if( idx in id_seq_to_visualize):
        ...
        if (TNET_FLAG == True):
          transform_l0 = end_points['transform_l0']
          transform_l1 = end_points['transform_l1']
          transform_l2 = end_points['transform_l2']
          transform_l3 = end_points['transform_l3']
          print("ID: ", idx)
          print("transform_l0", transform_l0)
          print("transform_l1", transform_l1)
          print("transform_l2", transform_l2)
          print("transform_l3", transform_l3)
